...
public class LanzadorMultiplicador {
    ...
    public void lanzarMultiplicador(int n1, int n2, String fResultado) throws IOException, InterruptedException {
        ...
        try {
            ...
            //"com.psp.dos.multiplicador.Multiplicador" --> Es el nombre completo de la clase principal que se va a ejecutar
            //String.valueOf(n1): Convierte el valor de n1 a una cadena. Este será el primer argumento para el programa Java.
    ...
    public static void main(String[] args) throws Exception {
        ...
        l.lanzarMultiplicador(5, 5, "resultadoMultiplicacion.txt");
    }
}